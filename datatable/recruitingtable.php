<html>
<head>
	<title> Recruiting Agency DataTable </title>
...
<body>
	<h1 style="text-align:center;">RecruitingAgency Datatable</h1>
<div class="container">
	<table id="form" class="table table-striped table-bordered">
		...
		<tbody>
			...
			<?php
			    ...
			    $query = mysqli_query($conn,"SELECT * FROM recruiting_agency ORDER BY RaName");

			    while($result=mysqli_fetch_array($query)){
			    	echo "<tr>
			    	<td>".$result['ID']."</td>
			    	<td>".$result['PermissionNo']."</td>
			    	<td>".$result['RaName']."</td>
