<html>
<head>
	<title> Orientation DataTable </title>
...
<body>
	<h1 style="text-align:center;">Orientation Datatable</h1>
	<div class="container">
	<table id="form" class="table table-striped table-bordered">
		<thead>
			<th>ID</th>
			<th>PermissionNumber</th>
		...
		<tbody>
			<?php
			    ...
			    $query = mysqli_query($conn,"SELECT * FROM orientation ORDER BY OrName");
