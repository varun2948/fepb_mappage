<html>
<head>
	<title> Migrant Resource DataTable </title>
...
<body>
	<h1 style="text-align:center;">Migrant Resource Datatable</h1>
	<div class="container">
	<table id="form" class="table table-striped table-bordered">
		...
		<tbody>
			...
			<?php
			    ...
			    $query = mysqli_query($conn,"SELECT * FROM fepb_MRC ORDER BY MigrantResource_Name");

			    while($result=mysqli_fetch_array($query)){
			    	echo "<tr>
			    	<td>".$result['ID']."</td>
			    	<td>".$result['MigrantResource_Name']."</td>
